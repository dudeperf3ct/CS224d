...
#         embedd = tf.nn.embedding_lookup(params=embed, ids=self.input_placeholder)
#         embeddings = tf.reshape(embedd, shape=[-1, self.config.n_features*self.config.embed_size])
#         ### END YOUR CODE
#         return embeddings
...
#         b1 = tf.get_variable("biases1", [self.config.hidden_size], 
#             initializer=tf.constant_initializer(0.0))
#         U = tf.get_variable("U", [self.config.hidden_size, self.config.n_classes],
#             initializer=xavier_weight_init())
#         b2 = tf.get_variable("biases2", [self.config.n_classes], 
#             initializer=tf.constant_initializer(0.0))
